...
The follwoing paths are covered:
  ...
  - [Microsoft Applied Skills: Administer AD DS Assessment Lab](https://learn.microsoft.com/en-us/credentials/applied-skills/administer-active-directory-domain-services/)
  - [Microsoft Intune Fundamentals Training Path](https://learn.microsoft.com/en-us/training/paths/endpoint-manager-fundamentals/)
  - [Deploy using Endpoint Configuration Manager Module](https://learn.microsoft.com/en-us/training/modules/deploy-use-endpoint-configuration-manager/)
  - [Plan for Windows 11 Deployment & Management](https://learn.microsoft.com/en-us/windows/whats-new/windows-11-plan)
  - [Windows 11 Security Book (Deep Dive)](https://learn.microsoft.com/en-us/windows/security/book/)
